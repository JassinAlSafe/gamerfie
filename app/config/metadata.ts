export const siteMetadata = {
  ...
  authors: [{ name: "Game Vault Team", url: process.env.NEXT_PUBLIC_API_BASE || "http://localhost:3000" }],
  creator: "Game Vault",
...
export const structuredData = {
  ...
  "potentialAction": {
    ...
    "target": {
      "@type": "EntryPoint",
      "urlTemplate": `${process.env.NEXT_PUBLIC_API_BASE || "http://localhost:3000"}/search?q={search_term_string}`
    },
...
export const organizationStructuredData = {
  ...
  "name": "Game Vault",
  "url": process.env.NEXT_PUBLIC_API_BASE || "http://localhost:3000",
  "logo": `${process.env.NEXT_PUBLIC_API_BASE || "http://localhost:3000"}/logo.svg`,
  "description": "Ultimate video game tracker and gaming community platform",
  "foundingDate": "2024",
  "contactPoint": {
    "@type": "ContactPoint",
    "contactType": "customer service",
    "url": `${process.env.NEXT_PUBLIC_API_BASE || "http://localhost:3000"}/info/contact`
  }
};