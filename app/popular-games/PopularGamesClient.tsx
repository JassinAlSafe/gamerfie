...
export default function PopularGamesClient() {
  ...
  // Structured data for popular games page
  const generateStructuredData = () => {
    ...
    const structuredData = {
      ...
      "@type": "CollectionPage",
      "name": "Popular Video Games - Game Vault",
      "description": "Discover the most popular video games. Track your progress, read reviews, and connect with the gaming community on Game Vault.",
        ...
        "itemListElement": [
          {
            ...
            "position": 1,
            "name": "Home",
            "item": "https://gamersvaultapp.com"
          },
          {
            "@type": "ListItem", 
            "position": 2,
            "name": "Explore",
            "item": "https://gamersvaultapp.com/explore"
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": "Popular Games",
            "item": "https://gamersvaultapp.com/popular-games"
          }
        ]
      },
      "mainEntity": {
        "@type": "ItemList",
        "numberOfItems": data.all.length,
        "itemListElement": data.all.slice(0, 10).map((game: Game, index: number) => ({
          "@type": "VideoGame",
          "position": index + 1,
          "name": game.name,
          "url": `https://gamersvaultapp.com/game/${game.id}`,
          "image": game.cover?.url ? ensureAbsoluteUrl(game.cover.url) : undefined,
