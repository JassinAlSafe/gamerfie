      ...
      {Array(18)
        ...
        .map((_, i) => (
          <div key={i} className="group">
            <div className="aspect-[3/4] bg-gray-800/50 rounded-lg animate-pulse mb-2"></div>
            <div className="h-4 w-full bg-gray-800/50 rounded animate-pulse mb-1"></div>
