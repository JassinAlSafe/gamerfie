  ...
  const handleProgressUpdate = useCallback(
    async (progress: Partial<GameProgress>) => {
      ...
      const updateData = {
        ...
        achievements_completed:
          progress.achievementsCompleted ?? (achievements_completed || 0),
      };

      console.log(
        "UpdateProgressButton: Updating progress with data:",
        updateData
      );
      ...
      try {
        ...
        if (!libraryEntry || (libraryEntry as any).status !== newStatus) {
