...
const defaultLayouts = {
  lg: [
    ...
    { i: "library", x: 0, y: 1, w: 2, h: 2, minW: 1, minH: 2 },
    { i: "journal", x: 2, y: 1, w: 2, h: 2, minW: 1, minH: 2 },
  ],
  md: [
    { i: "welcome", x: 0, y: 0, w: 1, h: 1 },
    { i: "friends", x: 1, y: 0, w: 1, h: 1 },
    { i: "activity", x: 0, y: 1, w: 1, h: 1 },
    { i: "library", x: 0, y: 2, w: 2, h: 2 },
    { i: "journal", x: 0, y: 4, w: 2, h: 2 },
  ],
  sm: [
    { i: "welcome", x: 0, y: 0, w: 1, h: 1 },
    { i: "friends", x: 0, y: 1, w: 1, h: 1 },
    { i: "activity", x: 0, y: 2, w: 1, h: 1 },
    { i: "library", x: 0, y: 3, w: 1, h: 2 },
    { i: "journal", x: 0, y: 5, w: 1, h: 2 },
  ],
};
